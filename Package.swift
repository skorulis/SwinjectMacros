...
let package = Package(
    ...
    products: [
        ...
        .executable(
            name: "SwinjectMacrosClient",
            targets: ["SwinjectMacrosClient"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .macro(
            name: "SwinjectMacrosImplementations",
            dependencies: [
        ...
        .target(name: "SwinjectMacros", dependencies: ["SwinjectMacrosImplementations"]),
